        ...
        <div className="navbar bg-neutral-focus">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex="0" className="menu menu-compact bg-neutral-focus dropdown-content mt-3 p-2 shadow rounded-box w-52">

                        {navItems}

                    </ul>
                </div>
                <Link to='/' className="btn btn-ghost normal-case text-xl text-white">Emon Hossain</Link>
            </div>
